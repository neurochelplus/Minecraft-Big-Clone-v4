...
describe("ProfilerOverlay", () => {
  it("creates and updates DOM overlay", () => {
    ...
    overlay.update({
      fps: 60,
      fpsLast: 58,
      frame: { avg: 16.67, max: 18.2, last: 16.4, min: 15.9, p95: 18, p99: 18.2 },
      frameSamples: [15.5, 16.2, 17.8, 16.4],
      sampleSize: 120,
      budgetMs: 16.67,
      sections: {
        update: { avg: 6.2, max: 7.8, last: 6.9, min: 6.1, p95: 7.1, p99: 7.8 },
      },
      values: {
        "queue.size": { avg: 4, max: 5, last: 5, min: 3, p95: 5, p99: 5 },
        "queue.mesh.pending": { avg: 2, max: 4, last: 1, min: 0, p95: 4, p99: 4 },
        "queue.burst.active": { avg: 0.2, max: 1, last: 1, min: 0, p95: 1, p99: 1 },
        "frame.local.p99": {
          avg: 15.8,
          max: 16.4,
          last: 16.1,
